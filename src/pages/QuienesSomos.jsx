  ...
  const principiosRectores = [
    {
      ...
      texto: "La dignidad humana es el valor intrínseco e inalienable que posee cada persona por el simple hecho de serlo, sin distinción alguna de su origen, condición o capacidades."
    },
    {
      titulo: "Defensa de los derechos humanos",
      texto: "Defender los derechos humanos significa velar por el cumplimiento de las garantías fundamentales que permiten a las personas vivir con libertad, justicia y paz."
    },
    {
      titulo: "Equidad de género",
      texto: "La equidad de género busca asegurar que todas las personas, independientemente de su sexo o identidad, tengan acceso a las mismas oportunidades y recursos."
    },
    {
      titulo: "Respeto y protección al medio ambiente",
      texto: "Este principio implica reconocer nuestra profunda interdependencia con la naturaleza y asumir la responsabilidad de preservar los recursos del planeta."
    },
    {
      titulo: "Ética y transparencia laboral",
      texto: "La ética y la transparencia son los pilares que sostienen la confianza institucional. Actuar con integridad significa tomar decisiones basadas en valores morales sólidos."
    },
    {
      titulo: "Inclusión social",
      texto: "La inclusión social es el proceso proactivo de integrar a todos los individuos en la vida comunitaria, valorando la diversidad como una riqueza."
    }
  ];
      ...
      <div className="relative overflow-hidden grow pb-10">
        ...
        <section className="relative pt-8 md:pt-12 px-0 md:px-8 z-10">
          <div className="max-w-7xl mx-auto bg-white overflow-hidden">
            ...
            <div className="px-8 md:px-12 lg:px-16 pb-8 animate-fade-in-up">
              
              {/* Texto Principal - Espacios reducidos y sin líneas divisorias */}
              ...
              {/* Misión y Visión - Diseño plano sin sombras ni bordes grises */}
              <div id="mision-vision" className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 scroll-mt-32">
                <div className="bg-gray-50 border-l-4 border-main-red p-8 rounded-r-xl">
                  ...
                  <p className="text-gray-700 text-base md:text-lg font-light leading-relaxed text-justify">
                    Promover el respeto y cumplimiento de los estándares internacionales en derechos humanos a través del litigio estratégico y proyectos de capacitación, brindando acompañamiento al sector público y privado.
                  </p>
                </div>
                <div className="bg-pale-blue/10 border-l-4 border-light-blue p-8 rounded-r-xl">
                  <h2 className="text-2xl font-extrabold text-main-blue mb-4 uppercase tracking-wider flex items-center gap-3">
                    <span className="bg-light-blue text-white w-8 h-8 flex items-center justify-center rounded-full text-lg font-black">V</span>
                    Visión
                  </h2>
                  <p className="text-gray-700 text-base md:text-lg font-light leading-relaxed text-justify">
                    Ser una institución que impulse el respeto y la inclusión de los derechos humanos mediante estrategias de defensa y capacitación, con la finalidad de construir una sociedad democrática.
                  </p>
                </div>
              </div>

              {/* Principios Rectores - Sin líneas ni sombras */}
        ...
        {/* Organigrama - Estructura compacta y plana */}
