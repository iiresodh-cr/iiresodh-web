    ...
    return (
      <main className="bg-white min-h-screen flex flex-col font-sans">
        ...
        <div className="relative overflow-hidden grow pb-20">
          ...
          {/* ESTRUCTURA CORREGIDA: FONDO BLANCO COMO EN ARTÍCULOS Y LITIGIO */}
              ...
              <div className="px-6 md:px-12 lg:px-16 py-12 md:py-16 animate-fade-in-up">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                  ...
                  {listaLibros.map((l) => {
                    ...
                    return (
                      // TARJETA CLÁSICA CON FONDO BLANCO Y BORDE
                      <div key={l.id} className="bg-white rounded-2xl border border-gray-100 shadow-md hover:shadow-xl transition-all overflow-hidden flex flex-col group">
                        
                        <Link to={`/comprar-libro/${l.slug}`} className="w-full aspect-4/5 bg-gray-50 flex items-center justify-center border-b border-gray-100 relative overflow-hidden">
                        ...
                        <div className="p-6 md:p-8 flex flex-col grow">
                          ...
                          <Link to={`/comprar-libro/${l.slug}`}>
                            <h3 className="text-xl font-extrabold text-main-blue mb-2 leading-tight uppercase group-hover:text-light-blue transition-colors">
                              {l.titulo}
                            </h3>
                          </Link>
                          ...
                          {l.resumen && (
                            <div className="mb-6 bg-blue-50/40 p-4 rounded-xl border border-blue-50">
                          ...
                          <div className="mt-auto pt-6 border-t border-gray-100 flex flex-wrap gap-4 items-center justify-between">
                            <span className="text-2xl font-black text-main-blue">
                              ${precioMostrar} <span className="text-xs font-medium text-gray-400">{monedaMostrar}</span>
                            </span>
                            <Link to={`/comprar-libro/${l.slug}`} className="bg-main-blue hover:bg-light-blue text-white font-bold py-2.5 px-6 rounded-xl text-xs uppercase tracking-widest transition-colors shadow-sm">
                              Comprar
                            </Link>
                          </div>
                        </div>
  ...
  return (
    <main className="bg-white min-h-screen flex flex-col font-sans">
      ...
      <div className="relative overflow-hidden grow pb-20">
        ...
        {/* ESTRUCTURA IDÉNTICA PARA LA VISTA INDIVIDUAL */}
        <section className="relative pt-12 md:pt-16 px-0 md:px-8 z-10">
          <div className="max-w-7xl mx-auto bg-white overflow-hidden md:rounded-3xl shadow-sm border border-gray-100">
