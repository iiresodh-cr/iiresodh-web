...
export default function Privacidad() {
  ...
  return (
    <div className="bg-basic-beige min-h-screen flex flex-col">
      ...
      <div className="relative overflow-hidden grow pb-20">
        ...
        <section className="relative z-10 px-0 md:px-8 pt-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8 px-6 md:px-0">
              <button
                ...
                className={`py-3 px-8 rounded-full font-bold uppercase tracking-widest text-sm transition-all shadow-sm ${
                  activeTab === "general"
              ...
              <button
                ...
                className={`py-3 px-8 rounded-full font-bold uppercase tracking-widest text-sm transition-all shadow-sm ${
                  activeTab === "mexico"
                    ...
                    : "bg-white text-main-red border border-gray-200 hover:bg-red-50"
                }`}
              >
                Aviso para México
              </button>
              ...
              {activeTab === "general" && (
                <div className="space-y-8 text-lg text-gray-700 leading-loose animate-fade-in-up">
                  ...
                  <div>
                    ...
                    <p className="mt-4">Al utilizar cualquiera de nuestros sitios o servicios, usted reconoce que ha leído y acepta las prácticas descritas en esta Política de Privacidad. Si no está de acuerdo con esta política, por favor, no utilice nuestros servicios.</p>
                  </div>
                  ...
                  <div>
                    ...
                    <h4 className="text-xl font-bold text-main-blue mt-6 mb-3">3.2. Información Específica del Servicio PIDA-AI</h4>
                    <p className="mb-3">Además de la información anterior, si usted es usuario del Servicio PIDA-AI, recopilamos:</p>
                    <ul className="list-disc pl-6 space-y-2">
                  ...
                  <div>
                    ...
                    <h4 className="text-xl font-bold text-main-blue mt-6 mb-3">4.2. Para el Servicio PIDA-AI:</h4>
                    <ul className="list-disc pl-6 space-y-2">
                  ...
                  <div>
                    ...
                    <p className="mt-4">Para ejercer cualquiera de estos derechos, puede contactarnos a través del correo electrónico: <a href="mailto:contacto@iiresodh.org" className="text-light-blue hover:text-main-blue font-bold">contacto@iiresodh.org</a>.</p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg mt-4 border border-gray-200">
                      ...
                      <p className="mt-2"><strong>Correo electrónico:</strong> <a href="mailto:contacto@iiresodh.org" className="text-light-blue hover:text-main-blue">contacto@iiresodh.org</a></p>
                      <p className="mt-2"><strong>Dirección:</strong> Centro Corporativo San Rafael, piso 3, oficina 28, San José, CP-10203, Costa Rica.</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {activeTab === "mexico" && (
                <div className="space-y-8 text-lg text-gray-700 leading-loose animate-fade-in-up">
                  ...
                  <div>
                    ...
                    <p>Este es el Aviso de Privacidad del Instituto Internacional de Responsabilidad Social y Derechos Humanos (en adelante, “IIRESODH”). Este documento describe cómo tratamos los datos personales de los usuarios (en adelante, el “Titular” o “usted”) de:</p>
                    <ul className="list-disc pl-6 mt-4 space-y-2 font-medium">
                      <li>Nuestro sitio web institucional: <a href="https://iiresodh.org" className="text-light-blue hover:text-main-blue transition-colors">https://iiresodh.org</a> (en adelante, el “Sitio Web General”).</li>
                      <li>Nuestro servicio de inteligencia artificial por suscripción: <a href="https://pida-ai.com" target="_blank" rel="noopener noreferrer" className="text-light-blue hover:text-main-blue transition-colors">https://pida-ai.com</a> (en adelante, el “Servicio PIDA-AI”).</li>
                    </ul>
                    <p className="mt-4">Al proporcionarnos sus datos personales y/o utilizar nuestros servicios, usted otorga su consentimiento para el tratamiento de sus datos conforme a este Aviso de Privacidad.</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="font-bold mt-4">En el Servicio PIDA-AI:</p>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <p className="mt-4">Usted puede manifestar su negativa para el tratamiento de sus datos para estas finalidades secundarias enviando un correo a <a href="mailto:contacto@iiresodh.org" className="text-light-blue hover:text-main-blue font-bold">contacto@iiresodh.org</a>.</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-4">Asimismo, usted puede <strong>revocar el consentimiento</strong> que nos haya otorgado y <strong>limitar el uso o divulgación</strong> de su información personal.</p>
                    <p className="mt-4">Para ejercer cualquiera de estos derechos, deberá enviar una solicitud por escrito al correo electrónico <a href="mailto:contacto@iiresodh.org" className="text-light-blue hover:text-main-blue font-bold">contacto@iiresodh.org</a>, la cual deberá contener:</p>
                  ...
                  <div>
                    ...
                    <p>Si tiene alguna pregunta sobre este Aviso de Privacidad, puede contactarnos en:</p>
                    <div className="bg-gray-50 p-6 rounded-lg mt-4 border border-gray-200">
                      <p><strong>Instituto Internacional de Responsabilidad Social y Derechos Humanos – IIRESODH</strong></p>
                      <p className="mt-2"><strong>Correo electrónico:</strong> <a href="mailto:contacto@iiresodh.org" className="text-light-blue hover:text-main-blue">contacto@iiresodh.org</a></p>
                      <p className="mt-2"><strong>Domicilio:</strong> Centro Corporativo San Rafael, piso 3, oficina 28, San José, CP-10203, Costa Rica.</p>
                    </div>
                  </div>
                </div>
              )}
