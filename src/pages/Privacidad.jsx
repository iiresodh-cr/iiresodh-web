                ...
                <div className={legalTextClass}>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li><strong>Datos de Trazabilidad Digital:</strong> Para la adquisición de libros y manuales en formato PDF, recopilamos y procesamos su dirección IP, identificadores de dispositivo y datos de geolocalización para la prevención de piratería y cumplimiento de términos de licencia personal.</li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li><strong>Protección de Propiedad Intelectual:</strong> Validar la integridad de la entrega de material digital, rastrear el uso autorizado de archivos PDF y prevenir la distribución ilícita o piratería de contenidos protegidos. (Base legal: Interés legítimo y cumplimiento contractual).</li>
                  ...
                  <div>
                    ...
                    <p>IIRESODH aplica medidas de seguridad técnicas y organizativas para proteger su información contra accesos no autorizados, pérdida o alteración. Nuestro sitio utiliza certificados SSL para cifrar la información durante la transmisión. En el caso de libros digitales, se emplean metadatos de trazabilidad invisibles para garantizar la protección de la propiedad intelectual de la institución.</p>
                  </div>
                ...
                <div className={legalTextClass}>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li><strong>Datos de Navegación y Transacción Digital:</strong> Dirección IP, metadatos de archivos descargados, geolocalización e identificadores únicos de dispositivos vinculados a la compra de manuales académicos.</li>
                    </ul>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 mb-4 space-y-1">
                      ...
                      <li>Procesar la venta de material bibliográfico digital y asegurar la integridad de los activos mediante medidas técnicas de prevención de piratería e infracciones a la Ley Federal del Derecho de Autor.</li>
                    </ul>
              ...
              {activeTab === "terminos" && (
                <div className={legalTextClass}>
                  ...
                  <div>
                    ...
                    <h4 className="text-base md:text-lg font-bold text-main-red mt-5 mb-2">4.1. Política Estricta Anti-Piratería y Uso de Material Digital (PDF)</h4>
                    <div className="bg-gray-50 p-6 md:p-8 rounded-2xl border border-gray-200 mb-6 space-y-4">
                      <p className="font-bold text-main-blue">Al adquirir o descargar material académico en formato PDF de IIRESODH, usted acepta los siguientes términos de carácter vinculante y estricto:</p>
                      <ul className="list-decimal pl-6 space-y-4 font-medium text-gray-800">
                        <li><strong>Licencia Unipersonal e Intransferible:</strong> La compra de un libro digital otorga únicamente una licencia de uso personal, privada y no exclusiva. Queda terminantemente prohibida su reproducción, venta, préstamo o comunicación pública.</li>
                        <li><strong>Prohibición de Redistribución Digital:</strong> No está permitido compartir, enviar por correo electrónico, subir a servidores de almacenamiento público (Drive, Dropbox, etc.), o publicar en redes sociales el archivo PDF adquirido.</li>
                        <li><strong>Trazabilidad y Rastreo Digital:</strong> IIRESODH emplea identificadores únicos, marcas de agua criptográficas y metadatos invisibles vinculados a la transacción de cada comprador. En caso de detectarse una copia en circulación ilegal, el adquirente original será identificado y denunciado judicialmente.</li>
                        <li><strong>Caducidad de los Enlaces de Descarga:</strong> Por seguridad de la propiedad intelectual, los enlaces enviados tienen una validez estricta de <strong>48 horas</strong>. Es responsabilidad exclusiva del usuario resguardar su archivo en dicho plazo.</li>
                        <li><strong>Sanciones Legales:</strong> El incumplimiento de estas condiciones constituye un delito federal y activará acciones legales penales y civiles bajo las leyes internacionales de propiedad intelectual y el Código Penal correspondiente.</li>
                      </ul>
                    </div>

                    <h4 className="text-base md:text-lg font-bold text-main-blue mt-5 mb-2">4.2. Licencia Creative Commons</h4>
                    <p className="mb-3">Salvo para el material bibliográfico de venta y descarga protegida detallado en el punto anterior, el contenido general informativo de este Sitio Web se encuentra bajo una licencia <strong>Creative Commons Atribución-NoComercial-SinDerivadas 4.0 Internacional (CC BY-NC-ND 4.0)</strong>. Esto significa que usted es libre de compartir (copiar y redistribuir el material informativo en cualquier medio o formato) bajo los siguientes términos:</p>
                    <ul className="list-disc pl-6 space-y-2">
