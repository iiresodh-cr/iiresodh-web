      ...
      <div className="relative overflow-hidden grow pb-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto bg-white px-6 md:px-12 pt-8 md:pt-12 pb-16 flex flex-col gap-12 md:gap-16">
          ...
          <div className="pt-12 border-t border-gray-100">
            ...
            <div className="relative w-full max-w-4xl mx-auto aspect-3/4 md:aspect-square bg-pale-blue/5 rounded-2xl overflow-hidden border border-gray-100 shadow-inner flex items-center justify-center p-4">
