    ...
    <div className="bg-white flex flex-col min-h-screen">
      <div className="relative overflow-hidden grow">
        ...
        <section className="relative py-20 px-8 z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8 text-main-blue text-lg md:text-xl font-light leading-relaxed bg-white/60 backdrop-blur-sm p-8 md:p-12 rounded-2xl">
            <p className="italic">
