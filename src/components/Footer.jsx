        ...
        <div className="flex flex-col items-start lg:items-end">
          ...
          <div className="flex items-center gap-4 text-gray-300 mb-8" role="group" aria-label="Redes sociales">
            <Tooltip title={t('footer.siguenos_facebook', 'Síguenos en Facebook')} arrow placement="top" slots={{ transition: Zoom }}>
              <a 
                href="https://www.facebook.com/iiresodhcostarica" 
                target="_blank" 
                rel="noreferrer" 
                aria-label={t('footer.siguenos_facebook', 'Síguenos en Facebook')}
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-main-red hover:text-white transition-all"
              >
            ...
            <Tooltip title={t('footer.siguenos_instagram', 'Síguenos en Instagram')} arrow placement="top" slots={{ transition: Zoom }}>
              <a 
                href="https://www.instagram.com/iiresodh" 
                target="_blank" 
                rel="noreferrer" 
                aria-label={t('footer.siguenos_instagram', 'Síguenos en Instagram')}
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-main-red hover:text-white transition-all"
              >
            ...
            <Tooltip title={t('footer.siguenos_x', 'Síguenos en X')} arrow placement="top" slots={{ transition: Zoom }}>
              <a 
                href="https://x.com/IIRESODH1" 
                target="_blank" 
                rel="noreferrer" 
                aria-label={t('footer.siguenos_x', 'Síguenos en X')}
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-main-red hover:text-white transition-all"
              >
            ...
            <Tooltip title={t('footer.siguenos_tiktok', 'Síguenos en TikTok')} arrow placement="top" slots={{ transition: Zoom }}>
              <a 
                href="https://www.tiktok.com/@iiresodh" 
                target="_blank" 
                rel="noreferrer" 
                aria-label={t('footer.siguenos_tiktok', 'Síguenos en TikTok')}
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-main-red hover:text-white transition-all"
              >
