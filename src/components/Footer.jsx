    ...
    <footer className="flex flex-col relative z-40 bg-main-blue text-white mt-auto">
      ...
      <div className="max-w-7xl mx-auto w-full px-8 py-16 md:py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
        ...
        <div className="flex flex-col items-start lg:items-end">
          <h3 className="text-sm font-bold tracking-[0.2em] text-white uppercase mb-6 lg:text-right">Conecta con nosotros</h3>
          
          <div className="flex items-center gap-4 text-gray-300 mb-8" role="group" aria-label="Redes sociales">
            <Tooltip title="Síguenos en Facebook" arrow placement="top" slots={{ transition: Zoom }}>
            ...
            <Tooltip title="Síguenos en Instagram" arrow placement="top" slots={{ transition: Zoom }}>
            ...
            <Tooltip title="Síguenos en X" arrow placement="top" slots={{ transition: Zoom }}>
            ...
            <Tooltip title="Síguenos en YouTube" arrow placement="top" slots={{ transition: Zoom }}>
            ...
            <Tooltip title="Síguenos en LinkedIn" arrow placement="top" slots={{ transition: Zoom }}>
            ...
            <Tooltip title="Síguenos en TikTok" arrow placement="top" slots={{ transition: Zoom }}>
