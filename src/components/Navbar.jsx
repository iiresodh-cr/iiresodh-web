          ...
          <div className="bg-white px-6 py-4 flex flex-col md:flex-row justify-between md:justify-end items-center gap-6">
            <div className="w-full md:w-auto md:flex-1 max-w-md md:mr-auto">
              <form onSubmit={handleSearch} className="relative group">
                <label htmlFor="navbar-search" className="sr-only">Buscar noticias o información en el sitio</label>
                <input
                  id="navbar-search"
                  type="text"
                  value={searchTerm}
            ...
            <div className="hidden md:flex items-center gap-6 text-light-blue shrink-0" role="group" aria-label="Redes sociales">
              <a href="https://www.facebook.com/iiresodhcostarica" target="_blank" rel="noreferrer" className="hover:text-main-blue transition-colors" aria-label="Visitar nuestro Facebook">
              ...
              <a href="https://www.instagram.com/iiresodh" target="_blank" rel="noreferrer" className="hover:text-main-blue transition-colors" aria-label="Visitar nuestro Instagram">
              ...
              <a href="https://x.com/IIRESODH1" target="_blank" rel="noreferrer" className="hover:text-main-blue transition-colors" aria-label="Visitar nuestro perfil en X">
              ...
              <a href="https://www.youtube.com/@iiresodh" target="_blank" rel="noreferrer" className="hover:text-main-blue transition-colors" aria-label="Visitar nuestro canal de YouTube">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M21.582 6.186a2.658 2.658 0 00-1.874-1.886C18.053 3.846 12 3.846 12 3.846s-6.053 0-7.708.454a2.658 2.658 0 00-1.874 1.886C1.964 7.857 1.964 12 1.964 12s0 4.143.454 5.814a2.658 2.658 0 001.874 1.886C5.947 20.154 12 20.154 12 20.154s6.053 0 7.708-.454a2.658 2.658 0 001.874-1.886C22.036 16.143 22.036 12 22.036 12s0-4.143-.454-5.814zM9.965 15.485V8.515L15.918 12l-5.953 3.485z" /></svg>
              </a>
            </div>
          </div>
          ...
          <div className="bg-white px-6 py-2 flex flex-col md:flex-row md:items-center justify-between grow">
            ...
            <nav className="w-full md:w-auto flex flex-col md:flex-row justify-center md:items-center gap-2 md:gap-5 text-sm font-bold tracking-widest uppercase text-main-blue order-1 md:order-2" aria-label="Menú principal">
              ...
              <div className="relative group w-full md:w-auto" onMouseLeave={() => setActiveDropdown(null)}>
                ...
                <div 
                  id="dropdown-areas"
                  className={`${activeDropdown === 'areas' ? 'block' : 'hidden'} md:block md:absolute md:left-0 md:top-full md:w-72 md:bg-white md:shadow-xl md:rounded-b md:opacity-0 md:invisible md:group-hover:opacity-100 md:group-hover:visible transition-all duration-300 md:border-t-4 md:border-main-red w-full bg-gray-50 border-l-4 border-main-red md:border-l-0 z-50`}
                >
                  <ul className="py-2 flex flex-col">
                    ...
                    <li className="block w-full px-5 py-2 mt-2 text-xs font-bold text-gray-400 uppercase tracking-widest border-t border-gray-200/60 pt-3 cursor-default" aria-hidden="true">Cursos</li>
