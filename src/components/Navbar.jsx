    ...
    <header className="w-full shadow-sm relative z-50">
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4 md:gap-6 text-[#1D3557]">
            <a href="https://www.facebook.com/iiresodhcostarica" target="_blank" rel="noreferrer" className="hover:text-[#B92F32] transition-colors">
            ...
            <a href="https://www.instagram.com/iiresodh" target="_blank" rel="noreferrer" className="hover:text-[#B92F32] transition-colors">
            ...
            <a href="https://x.com/IIRESODH1" target="_blank" rel="noreferrer" className="hover:text-[#B92F32] transition-colors">
      ...
      <div className="bg-[#1D3557] text-white sticky top-0 shadow-md">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between min-h-[60px] flex-wrap md:flex-nowrap py-2 md:py-0">
          <div className="w-full md:w-auto flex justify-center md:justify-start order-2 md:order-1 mt-2 md:mt-0">
            {!isHome ? (
              <Link to="/" className="flex items-center gap-2 text-sm font-bold text-[#A8DADC] hover:text-white transition-colors">
          ...
          <nav className="w-full md:w-auto flex justify-center items-center gap-4 md:gap-8 text-sm font-semibold tracking-wide order-1 md:order-2">
            <div className="relative group cursor-pointer py-4">
              <span className="flex items-center gap-1 hover:text-[#A8DADC] transition-colors">
              ...
              {/* MENÚ ACTUALIZADO */}
              <div className="absolute left-0 top-full w-48 bg-white text-[#1D3557] shadow-xl rounded-b opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 border-t-4 border-[#B92F32]">
                <ul className="py-2">
            ...
            <div className="relative group cursor-pointer py-4">
              ...
              <div className="absolute left-0 top-full w-56 bg-white text-[#1D3557] shadow-xl rounded-b opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 border-t-4 border-[#B92F32]">
                <ul className="py-2">
            ...
            <Link to="/noticias" className="hover:text-[#A8DADC] py-4 transition-colors">NOTICIAS</Link>
          </nav>

          <div className="w-full md:w-auto flex justify-center md:justify-end order-3 mt-2 md:mt-0 pb-2 md:pb-0">
            <Link to="/" className="bg-[#B92F32] hover:bg-[#E63946] text-white px-6 py-2 rounded font-extrabold uppercase text-sm tracking-wider shadow-md transition-colors">
              DONACIONES
            </Link>
          </div>
        </div>
