...
exports.chatPida = onCall({ 
  ...
  try {
    ...
    const model = genAI.getGenerativeModel({ 
        ...
        7. DONACIONES: Si preguntan cómo apoyar, agradéceles, explícales que pronto estará disponible la sección de "Donaciones" y guíalos a la sección de "Donaciones".
